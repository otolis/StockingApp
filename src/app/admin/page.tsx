                                ...
                                {isAlertsExpanded && (
                                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 p-4 md:p-6 bg-amber-500/5">
                                        {lowStockItems.map(item => (
                                            <div key={item.id} className="alert-card p-4 border-2 border-amber-500/30 bg-black hover:border-amber-500 transition cursor-pointer shadow-[4px_4px_0px_rgba(245,158,11,0.2)]"
