...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-black text-white font-mono overflow-x-hidden">
      ...
      {/* Hero Section */}
      <main ref={heroRef} className="max-w-7xl mx-auto px-8 pt-48 pb-32 relative">
        <div className="space-y-12">
          ...
          <h1 className="hero-title text-7xl md:text-8xl font-black uppercase tracking-tighter leading-[0.9]">
            <span className="block opacity-0">Inventory</span>
            <span className="block opacity-0 text-stroke-2 text-transparent" style={{ WebkitTextStroke: '2px currentColor' }}>Management</span>
            <span className="block opacity-0 text-[#FFB800]">Perfected.</span>
          </h1>

          <p className="hero-description opacity-0 max-w-2xl text-lg font-medium leading-relaxed opacity-70">
          ...
          <div className="hero-buttons flex flex-col sm:flex-row items-center gap-6 pt-4">
            <Link
              href="/login"
              className="opacity-0 w-full sm:w-auto px-10 py-5 border-4 border-white bg-white text-black text-lg font-black uppercase tracking-widest shadow-[10px_10px_0px_rgba(255,184,0,1)] hover:translate-x-1 hover:translate-y-1 hover:shadow-none transition-all flex items-center justify-center gap-4 group"
            >
              Open Dashboard
            ...
            <Link
              href="/about"
              className="opacity-0 w-full sm:w-auto px-10 py-5 border-4 border-white bg-transparent text-white text-lg font-black uppercase tracking-widest hover:bg-white/5 transition"
            >
              Learn More
            </Link>
          </div>
        ...
        {/* Features */}
        <div ref={featuresRef} className="mt-48 grid grid-cols-1 md:grid-cols-3 gap-8">
      ...
      {/* Footer */}
      <footer ref={footerRef} className="mt-32 border-t-2 border-white py-12">
        <div className="footer-content max-w-7xl mx-auto px-8 flex flex-col md:flex-row justify-between items-center gap-8">
          ...
          <div className="opacity-0 text-xs uppercase tracking-widest opacity-60">
